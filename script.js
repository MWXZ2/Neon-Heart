...
let currentTheme = 'cosmic'; // Default theme set to 'cosmic'
let morphTarget = 1;         // CHANGED: Target is now 1 (Heart shape)
let morphProgress = 1;       // CHANGED: Initial progress is 1 (starts fully morphed)
